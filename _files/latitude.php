...
<body>
<?
echo "<div class='location'><a style='color: #007299;' href='http://maps.google.com/?q=$place' rel='external' target='_blank' title='".$coordinates."'><span class='icon icon-location-marker-16 fancybox-iframe'></span> $place <time class='status-date'>".getRelativeTime($timestamp)."</time></a></div>";
