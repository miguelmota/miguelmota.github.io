...
if(typeof window.history.pushState!="function")if(window.location.hash=="#!")window.location="/";$("ul#nav li a").each(function(){if($(this).attr("href")==pathname.substr(1)){alert(pathname);switch($(this).attr("id")){case "stream":streamPage();break;case "portfolio":portfolioPage();break;case "contact":contactPage();break;case "blog":blogPage();break;default:break}}else{streamPage();document.title="Miguel Mota | Freelance Web Developer"}});$("a#"+$("span.sub").text()).addClass("selected");$("body").append("<div class='theTitle' style='display: none;'> &#8212; Miguel Mota | Freelance Web Developer</div>");
...
break;case "portfolio":portfolioPage();break;case "contact":contactPage();alert("sdfsdf");break;case "blog":blogPage();alert("asdf");break;default:break}if(window.location.pathname.substr(1,4)=="post")while(bc==0){blogPage();$("nav.main a#stream").removeClass("selected");$("nav.main a#blog").addClass("selected");bc++}if(window.location.pathname.substr(1)=="archive"){$("nav.main a#stream").removeClass("selected");$("nav.main a#blog").addClass("selected")}});var c=0;var bc=0;var pathname=window.location.pathname;
