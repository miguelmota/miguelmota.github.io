...
true){var str=$("form.contact-form").serialize();$.ajax({type:"get",url:"http://www.foodfail.org/miguelmota/contact.php",data:str,success:function(){success()},error:function(){$("a.contact-submit").html("<span>sending...</span>");$("form.contact-form").html("<p>Sorry, there was an error. Message was not sent.</p><p>Email <a href='mailto:hello@miguelmota.com'>hello@miguelmota.com</a>?</p>")}});return false}else return false});function success(){$("a.contact-submit").html("<span>sending...</span>");
