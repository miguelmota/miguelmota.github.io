...
"function")if(window.location.hash)loadPage();else redirectPath();function loadPage(){var toLoad=window.location.hash.substr(1)+" section.content";window.location.hash=window.location.hash.substr(1);$("section.content").fadeOut("fast",loadContent);$("div.loader").fadeIn("normal");function loadContent(){$("section.content").load(toLoad,showNewContent)}return false}if(typeof window.history.pushState!="function"){function redirectPath(){var pathname=window.location.pathname.substr(1);switch(pathname){case "":case "index":case "stream":break;
