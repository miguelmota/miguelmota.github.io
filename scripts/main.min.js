...
if(typeof window.history.pushState!="function")if(window.location.hash=="#!")window.location="/";switch(pathname.substr(1)){case "stream":streamPage();$("a#stream").addClass("selected");break;case "about":$("a#about").addClass("selected");break;case "portfolio":portfolioPage();$("a#portfolio").addClass("selected");break;case "contact":contactPage();$("a#contact").addClass("selected");break;case "blog":blogPage();$("a#blog").addClass("selected");break;default:break}$("ul#nav li a").each(function(){if($(this).attr("href")==
pathname);else{streamPage();document.title="Miguel Mota | Freelance Web Developer"}});$("a#"+$("span.sub").text()).addClass("selected");$("body").append("<div class='theTitle' style='display: none;'> &#8212; Miguel Mota | Freelance Web Developer</div>");if(typeof window.history.pushState!="function")if(window.location.hash)window.location="/"+window.location.hash.substr(2);$("a[href*=#]").click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==
