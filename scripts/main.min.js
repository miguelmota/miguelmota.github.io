...
scrollTop=parseInt(scrollTop);var offset=topYloc+scrollTop+"px";$("a.top-link").animate({top:offset},{duration:500,queue:false})});topYloc=parseInt($("a.top-link").css("top").substring(0,$("a.top-link").css("top").indexOf("px")))});$(window).scroll(function(){if(window.pageYOffset>=200)$("a.top-link").fadeIn(600);if(window.pageYOffset<200)$("a.top-link").fadeOut(185)});var bsc=0;
