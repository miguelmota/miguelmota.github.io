...
$.each(data.items,function(i,item){var thumbnail=item.media.m.replace("_m.jpg","_s.jpg");var photo=item.media.m.replace("_m.jpg","_b.jpg");htmlString+="<li><a class='fancybox' rel='flickr' href='"+photo+"' title='"+item.title+"' ><img src='"+thumbnail+"' alt='' /></a></li>";if(i==3)return false});$(".stream-flickr div.loader").css("display","none");$(".stream-flickr").append(htmlString+"</ul>");showMtip(".stream-logo-flickr");$("a.fancybox").fancybox({showCloseButton:false,titlePosition:"inside",
