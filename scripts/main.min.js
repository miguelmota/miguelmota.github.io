...
$(document).ajaxComplete(function(){var hash=window.location.hash.substr(2);switch(hash){case "":case "index":case "stream":streamPage();break;case "portfolio":portfolioPage();break;case "contact":contactPage();break;default:break}});
...
$("div.posti h3 a").live("click",function(){c=0;var toLoad2=$(this).attr("href")+" div.posti";window.location.hash="!"+$(this).attr("href").substr(1,$(this).attr("href").length);$("div.posti").fadeOut("fast",loadContent);$("div.loader").fadeIn("normal");function loadContent(){$("div.posti").load(toLoad2,showNewContent2);function showNewContent2(){$("nav.main a").removeClass("selected");$("#"+window.location.hash.substr(2)).addClass("selected");$("div.posti").fadeIn("normal",hideLoader);if(window.location.hash==
"#!");}}return false});var position=0;var length="portfolio".length;function textticker(){$("a#stream").html("stream".substring(0,position));$("a#about").html("about".substring(0,position));$("a#portfolio").html("portfolio".substring(0,position));$("a#contact").html("contact".substring(0,position));$("a#blog").html("blog".substring(0,position));if(position++==length)setTimeout("textticker()",1E3);else setTimeout("textticker()",60)}
