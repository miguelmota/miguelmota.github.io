...
$("div.posti h3 a").live("click",function(){var toLoad2=$(this).attr("href")+" div.posti";$("div.posti").fadeOut("fast",loadContent2);$("div.loader").fadeIn("normal");function loadContent2(){var stateObj2={foo2:$(this).attr("href")};history.pushState(stateObj2,"Title",$(this).attr("href"));$("div.posti").load(toLoad2,showNewContent2);function showNewContent2(){$("div.posti").fadeIn("normal",hideLoader);loadDisqus()}}return false});
