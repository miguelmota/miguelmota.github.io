...
function showNewContent(){$("nav.main a").removeClass("selected");$("#"+window.location.pathname).addClass("selected");$("section.content, footer.main").fadeIn("normal",hideLoader);var title=$("span.sub").text()+$("div.theTitle").text();document.title=title}function hideLoader(){$("div.loader").hide()}
