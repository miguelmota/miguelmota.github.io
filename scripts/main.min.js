...
enableKeyboardNav:true,onStart:function(){},onCancel:function(){},onComplete:function(){},onCleanup:function(){},onClosed:function(){},onError:function(){}};a(document).ready(function(){a.fancybox.init()})})(jQuery);$(document).ready(function(){if(window.innerWidth<=640)window.location="http://m.miguelmota.com";$("body").fadeIn(650,function(){$("div#ie").slideDown("slow")});$("div#ie a#close").click(function(){$("div#ie").slideUp("normal")});if(typeof window.history.pushState!="function")if(window.location.hash=="#!")window.location="/";switch(pathname.substr(1)){case "stream":streamPage();$("a#stream").addClass("selected");break;case "about":$("a#about").addClass("selected");break;case "portfolio":portfolioPage();
