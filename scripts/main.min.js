...
enableKeyboardNav:true,onStart:function(){},onCancel:function(){},onComplete:function(){},onCleanup:function(){},onClosed:function(){},onError:function(){}};a(document).ready(function(){a.fancybox.init()})})(jQuery);$(document).ready(function(){if(window.innerWidth<=640){setTimeout(function(){$("div#wrap").prepend("<a id='mobile_bar' href='/mobile'>view mobile site</a><a id='mobile_close' href='javascript:void(0);'>x</a>");$("a#mobile_bar").slideDown("slow")},3E3);$("a#mobile_close").live("click",function(){$(this).hide();$("a#mobile_bar").slideUp("normal")})}$("body").fadeIn(650,function(){$("div#ie").slideDown("slow")});$("div#ie a#close").click(function(){$("div#ie").slideUp("normal")});if(typeof window.history.pushState!=
