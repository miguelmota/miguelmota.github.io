...
enableKeyboardNav:true,onStart:function(){},onCancel:function(){},onComplete:function(){},onCleanup:function(){},onClosed:function(){},onError:function(){}};a(document).ready(function(){a.fancybox.init()})})(jQuery);$(document).ready(function(){if(screen.width<=640){$("h1.title").insertAfter(".nav-logo",function(){$(".sub").remove()});$("#cse-search-form").insertAfter(".blog-description")}$("body").fadeIn(650,function(){$("div.ie-bar").slideDown("slow")});$("div.ie-bar a.ie-bar-close").click(function(){$("div.ie-bar").slideUp("normal")});if(typeof window.history.pushState!="function")if(window.location.hash=="#!")window.location="/";$("a[href^=http]").live("click",function(){window.open(this.href);return false});
...
$.each(data.items,function(i,item){var thumbnail=item.media.m;var thumbnail_small=item.media.m.replace("_m.jpg","_s.jpg");var photo=item.media.m.replace("_m.jpg","_b.jpg");htmlString+="<li><a class='fancybox' rel='flickr' href='"+photo+"' title='"+item.title+"' ><img src='"+thumbnail+"' alt='' /></a></li>";if(i==3)return false});$(".stream-flickr div.loader").css("display","none");$(".stream-flickr").append(htmlString+"</ul>");showMtip(".stream-logo-flickr");$("a.fancybox").fancybox({showCloseButton:false,
