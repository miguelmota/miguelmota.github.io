...
showNewContent2);function showNewContent2(){$("div.posti").fadeIn("normal",hideLoader);loadDisqus()}}return false});function textticker(){$("a#stream").text("stream".substring(0,0));$("a#about").text("about".substring(0,0));$("a#portfolio").text("portfolio".substring(0,0));$("a#contact").text("contact".substring(0,0));$("a#blog").text("blog".substring(0,0));if(position++==8)setTimeout("textticker()",1E3);else setTimeout("textticker()",60)}
