...
true){var str=$("form.contact-form").serialize();$.ajax({type:"get",url:"http://miguelmota.webuda.com/contact/contact.php",data:str,success:function(){success()},error:function(){$("a.contact-submit").html("<span>sending...</span>");$("form.contact-form").slideUp(300,function(){$("form.contact-form").html("<p>Sorry, there was an error. Message was not sent.</p><p>Email <a href='mailto:hello@miguelmota.com?body="+$("input#message").val()+"'>hello@miguelmota.com</a>?</p>")})}});return false}else return false});
function success(){$("a.contact-submit").html("<span>sending...</span>");$("form.contact-form").slideUp(300,function(){$("form.contact-form").html("<p>Thank you <strong>"+$("input#name").val()+"</strong>, <br />Your message has been successfully sent!<br />I will get in touch with you soon.</p>").fadeIn(1200)})}}tc=0;
