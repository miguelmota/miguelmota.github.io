...
$(document).ajaxComplete(function(){if(typeof window.history.pushState!="function")var path2=window.location.hash.substr(2);else var path2=window.location.pathname;var title=$("h1.title span.sub").text()+$("div.theTitle").text();document.title=title;$("nav.main a").removeClass("selected");if(path2.substr(4)!="")$("nav.main a#stream").addClass("selected");else{$("nav.main a#"+pathname.substr(1)).addClass("selected");document.title="Miguel Mota | Freelance Web Developer"}switch(path2){case "":case "index":case "stream":streamPage();
