...
topYloc=parseInt($("a.top").css("top").substring(0,$("a.top").css("top").indexOf("px")))});$(window).scroll(function(){if(window.pageYOffset>=200)$("a.top").fadeIn(600);if(window.pageYOffset<200)$("a.top").fadeOut(185)});var c=0;$(document).ajaxComplete(function(){var hash=window.location.hash.substr(2);switch(hash){case "":case "index":case "stream":streamPage();break;case "portfolio":portfolioPage();break;case "contact":contactPage();break;case "blog":blogPage();alert("sadfsdf");break;default:break}});
...
300)}}function blogPage(){google.load("search","1");function OnLoad(){var searchControl=new google.search.SearchControl;var webSearch=new google.search.WebSearch;webSearch.setSiteRestriction("http://www.miguelmota.com");searchControl.addSearcher(webSearch);searchControl.draw(document.getElementById("search"))}google.setOnLoadCallback(OnLoad)};