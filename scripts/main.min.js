...
enableKeyboardNav:true,onStart:function(){},onCancel:function(){},onComplete:function(){},onCleanup:function(){},onClosed:function(){},onError:function(){}};a(document).ready(function(){a.fancybox.init()})})(jQuery);$(document).ready(function(){if(window.innerWidth<=640){$("div#wrap").prepend("<a id='mobile_bar' href='/mobile'>view mobile site</a><a id='mobile_close' href='javascript:void(0);'>x</a>");$("a#mobile_close").live("click",function(){$(this).hide();$("a#mobile_bar").slideUp("normal")})}$("div#ie a#close").click(function(){$("div#ie").slideUp("normal")});$("body").fadeIn(650,function(){$("div#ie").slideDown("slow")});if(typeof window.history.pushState!="function")if(window.location.hash=="#!")window.location=
"/";streamPage();$("nav.main a#stream").addClass("selected");var pathname=window.location.pathname;$("ul.nav li a").each(function(){if($(this).attr("href")==pathname){$("nav.main a#stream").removeClass("selected");$(this).addClass("selected");alert(pathname.substr(1));switch(pathname.substr(1)){case "":case "index":case "stream":streamPage();break;case "portfolio":portfolioPage();break;case "contact":contactPage();break;case "blog":blogPage();break;default:break}}});$("nav.main a#logo").live("click",
function(){$("nav.main a").removeClass("selected");$("nav.main a#stream").addClass("selected")});$("body").append("<div class='theTitle' style='display: none;'> &#8212; Miguel Mota | Freelance Web Developer</div>");if(typeof window.history.pushState!="function")if(window.location.hash)loadPage();else redirectPath();function loadPage(){var toLoad="/"+window.location.hash.substr(2)+" section.content";window.location.hash=window.location.hash.substr(1);$("section.content").fadeOut("fast",loadContent);
$("div.loader").fadeIn("normal");function loadContent(){$("section.content").load(toLoad,showNewContent)}return false}if(typeof window.history.pushState!="function"){function redirectPath(){var pathname=window.location.pathname.substr(1);switch(pathname){case "":case "index":case "stream":break;case "portfolio":break;case "contact":break;case "blog":break;window.location="./#!"+path;default:break}}}$(window).scroll(function(){var scrollTop=$(document).scrollTop();scrollTop=parseInt(scrollTop);var offset=
...
$(window).scroll(function(){if(window.pageYOffset>=200)$("a.top").fadeIn(600);if(window.pageYOffset<200)$("a.top").fadeOut(185)});var c=0;var bc=0;
$(document).ajaxComplete(function(){if(typeof window.history.pushState!="function")var path2=window.location.hash.substr(2);else var path2=window.location.pathname.substring(1);switch(path2){case "":case "index":case "stream":streamPage();break;case "portfolio":portfolioPage();break;case "contact":contactPage();break;case "blog":blogPage();break;default:break}if(window.location.pathname.substr(1,4)=="post")while(bc==0){blogPage();$("nav.main a#stream").removeClass("selected");$("nav.main a#blog").addClass("selected");
bc++}if(window.location.pathname.substr(1)=="archive"){$("nav.main a#stream").removeClass("selected");$("nav.main a#blog").addClass("selected")}});
$("nav.main a").live("click",function(){c=0;bc=0;var toLoad=$(this).attr("href")+" section.content";$("section.content").fadeOut("fast",loadContent);$("div.loader").fadeIn("normal");function loadContent(){$("section.content").load(toLoad,showNewContent)}if(typeof window.history.pushState=="function"){var stateObj={foo:$(this).attr("href")};history.pushState(stateObj,"Title",$(this).attr("href"))}else window.location.hash="!"+$(this).attr("href").substr(1,$(this).attr("href").length);return false});
$("div.posti h3 a").live("click",function(){var toLoad2=$(this).attr("href")+" div.posti";$("div.posti").fadeOut("fast",loadContent2);$("div.loader").fadeIn("normal");if(typeof window.history.pushState=="function"){var stateObj2={foo2:$(this).attr("href")};history.pushState(stateObj2,"Title2",$(this).attr("href"))}else window.location.hash="!"+$(this).attr("href").substr(1,$(this).attr("href").length);var title2=$(this).text()+$("div.theTitle").text();document.title=title2;function loadContent2(){$("div.posti").load(toLoad2,
showNewContent2);function showNewContent2(){$("div.posti").fadeIn("normal",hideLoader);loadDisqus()}}return false});
...
function showNewContent(){$("nav.main a").removeClass("selected");if(typeof window.history.pushState!="function")$("#"+window.location.hash.substr(2)).addClass("selected");$("#"+window.location.pathname.substr(1)).addClass("selected");$("section.content, footer.main").fadeIn("normal",hideLoader);var title=$("span.sub").text()+$("div.theTitle").text();document.title=title;if(typeof window.history.pushState!="function")if(window.location.hash=="#!"){$("#"+window.location.hash.substr(2));document.title=
theTitle}}function hideLoader(){$("div.loader").hide()}
...
function portfolioPage(){$("section.portfolio div.sort a#all").live("click",function(){$("section.portfolio div.sort a").removeClass("selected");$(this).addClass("selected");$("section.portfolio div.identity, section.portfolio div.web").slideDown("fast")});$("section.portfolio div.sort a#web").live("click",function(){$("section.portfolio div.sort a").removeClass("selected");$(this).addClass("selected");$("section.portfolio div.identity").slideUp("fast");$("section.portfolio div.web").slideDown("fast")});
$("section.portfolio div.sort a#identity").live("click",function(){$("section.portfolio div.sort a").removeClass("selected");$(this).addClass("selected");$("section.portfolio div.web").slideUp("fast");$("section.portfolio div.identity").slideDown("fast")});$("section.portfolio div.container").hover(function(){jQuery("div.overlay",this).fadeOut(300);$(this).css({"-webkit-box-shadow":"0 0 10px #fff","-moz-box-shadow":"0 0 10px #fff","box-shadow":"0 0 10px #fff"})},function(){jQuery("div.overlay",this).hide().fadeIn(300);
$(this).css({"-webkit-box-shadow":"2px 2px 5px #111","-moz-box-shadow":"2px 2px 5px #111","box-shadow":"2px 2px 5px #111"})});$("a.fancybox").fancybox({padding:0,transitionIn:"fade",transitionOut:"fade",speedIn:600,speedOut:200,overlayColor:"#000"})}
