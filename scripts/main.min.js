...
"/";streamPage();$("nav.main a#stream").addClass("selected");var pathname=window.location.pathname;$("ul.nav li a").each(function(){if($(this).attr("href")==pathname){$("nav.main a#stream").removeClass("selected");$(this).addClass("selected");switch($(this).attr("href").substr(1)){case "":case "index":case "stream":streamPage();break;case "portfolio":portfolioPage();break;case "contact":contactPage();break;case "blog":blogPage();break;default:break}}});$("nav.main a#logo").live("click",function(){$("nav.main a").removeClass("selected");
