...
true){var str=$("form.contact-form").serialize();$.ajax({type:"get",url:"http://miguelmota.webuda.com/contact/contact.php",data:str,success:function(){alert("sdfsdf");success()},error:function(){alert("sdfsdE#EEEEEf");$("form.contact-form").slideUp(300);$("a.contact-submit").html("<span>sending...</span>");setTimeout(function(){$("form.contact-form").html("<p>Sorry, there was an error. Message was not sent.</p>")},300)}});return false}else return false});function success(){$("form.contact-form").slideUp(300);
$("a.contact-submit").html("<span>sending...</span>");setTimeout(function(){$("form.contact-form").html("<p>Thank you <strong>"+$("input#name").val()+"</strong>, <br />Your message has been successfully sent!<br />I will get in touch with you soon.</p>").fadeIn(1200)},300)}}tc=0;
