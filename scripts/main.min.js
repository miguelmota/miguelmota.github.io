...
mouseleave:function(){jQuery("span.overlay",this).hide().fadeIn(300);$(this).css({"-webkit-box-shadow":"2px 2px 5px #111","-moz-box-shadow":"2px 2px 5px #111","box-shadow":"2px 2px 5px #111"})}});$(".project .image-container").live({mouseenter:function(){jQuery(".overlay-popup",this).stop().animate({bottom:"0"},200)},mouseleave:function(){jQuery(".overlay-popup",this).animate({bottom:"-100px"},150)}});$("a.fancybox").hover(function(){jQuery("span.zoom-icon",this).css("display","block")},function(){jQuery("span.zoom-icon",
this).hide()});$("a.fancybox").fancybox({showCloseButton:false,titlePosition:"inside",titleFormat:formatTitle,padding:0,transitionIn:"none",transitionOut:"none",speedIn:150,overlayColor:"#000",overlayOpacity:0.8});function formatTitle(title,currentArray,currentIndex,currentOpts){return'<div class="fancybox-title"><span><a href="javascript:void(0);" onclick="$.fancybox.close();">close X</a></span>'+(title&&title.length?"<strong>"+title+"</strong>":"")+"Image "+(currentIndex+1)+" of "+currentArray.length+
"</div>"}}
function contactPage(){$("a.contact-submit").live("click",function(){$.validator.addMethod("namecheck",function(value,element){return this.optional(element)||/^[a-zA-Z]+?\s?[a-zA-Z]+?\s?[a-zA-Z]+$/.test(value)});$("form.contact-form").validate({rules:{name:{namecheck:true,required:true},email:{required:true,email:true},message:{required:true,minlength:10}},messages:{name:{namecheck:"",required:""},email:{required:"",email:""},message:"",minlength:""},onkeyup:true,debug:true});if($("form.contact-form").valid()==true){var str=
