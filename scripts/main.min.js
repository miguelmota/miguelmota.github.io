...
$("div.posti h3 a").live("click",function(){var toLoad2=$(this).attr("href")+" div.posti";window.location.hash="!"+$(this).attr("href").substr(1,$(this).attr("href").length);$("div.posti").fadeOut("fast",loadContent2);$("div.loader").fadeIn("normal");function loadContent2(){$("div.posti").load(toLoad2,showNewContent2);function showNewContent2(){$("div.posti").fadeIn("normal",hideLoader);if(window.location.hash=="#!");}}return false});var position=0;var length="portfolio".length;
