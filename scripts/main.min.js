...
mouseleave:function(){jQuery("span.overlay",this).hide().fadeIn(300);$(this).css({"-webkit-box-shadow":"2px 2px 5px #111","-moz-box-shadow":"2px 2px 5px #111","box-shadow":"2px 2px 5px #111"})}});$(".project .image-container").live({mouseenter:function(){jQuery(".overlay-popup",this).stop().clearQueue().animate({bottom:"0"},{duration:200,easing:"cubicEaseOut"})},mouseleave:function(){jQuery(".overlay-popup",this).animate({bottom:"-90px"},150)}});$("a.fancybox").hover(function(){jQuery("span.zoom-icon",
