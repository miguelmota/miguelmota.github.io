...
function portfolioPage(){$("section.portfolio a#all").live("click",function(){$("section.portfolio div.identity, section.portfolio div.web").slideDown("fast")});$("section.portfolio a#web").live("click",function(){$("section.portfolio div.identity").slideUp("fast");$("section.portfolio div.web").slideDown("fast")});$("section.portfolio a#identity").live("click",function(){$("section.portfolio div.web").slideUp("fast");$("section.portfolio div.identity").slideDown("fast")});$("section.portfolio div.container").hover(function(){jQuery("div.overlay",
this).fadeOut(300);$(this).css({"-webkit-box-shadow":"0 0 10px #fff","-moz-box-shadow":"0 0 10px #fff","box-shadow":"0 0 10px #fff"})},function(){jQuery("div.overlay",this).hide().fadeIn(300);$(this).css({"-webkit-box-shadow":"2px 2px 5px #111","-moz-box-shadow":"2px 2px 5px #111","box-shadow":"2px 2px 5px #111"})});$("a.fancybox").fancybox({padding:0,transitionIn:"fade",transitionOut:"fade",speedIn:600,speedOut:200,overlayColor:"#000"})}
