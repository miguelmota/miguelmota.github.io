...
$(".project:not('.project-identity')").slideUp("fast");$(".project-identity").slideDown("fast")});$(".work-sort-code").live("click",function(){$(".work-sort-wrap a").removeClass("selected");$(this).addClass("selected");$(".project:not('.project-code')").slideUp("fast");$(".project-code").slideDown("fast")});$("div.image-container:has('a')").live({mouseenter:function(){jQuery("span.overlay",this).fadeOut(200);$(this).css({"-webkit-box-shadow":"0 0 10px #fff","-moz-box-shadow":"0 0 10px #fff","box-shadow":"0 0 10px #fff"})},
mouseleave:function(){jQuery("span.overlay",this).hide().fadeIn(300);$(this).css({"-webkit-box-shadow":"2px 2px 5px #111","-moz-box-shadow":"2px 2px 5px #111","box-shadow":"2px 2px 5px #111"})}});$(".image-container").wrapInner("<a href='"+$(this).attr("data-link")+"'></a>");$(".image-container").live({mouseenter:function(){jQuery(".overlay-popup",this).animate({bottom:"0"},200)},mouseleave:function(){jQuery(".overlay-popup",this).animate({bottom:"-100px"},150)}});$("a.fancybox").hover(function(){jQuery("span.zoom-icon",
