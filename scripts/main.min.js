...
if(window.location.pathname.substring(1,5)=="post"){$("#stream").removeClass("selected");$("#blog").addClass("selected")}else $("#stream").addClass("selected");streamPage();$("nav.main a#logo").live("click",function(){$("nav.main a").removeClass("selected");$("nav.main a#stream").addClass("selected")});$("body").append("<div class='theTitle' style='display: none;'> &#8212; Miguel Mota | Freelance Web Developer</div>");function loadPage(){var toLoad=window.location.hash.substr(2)+" section.content";
