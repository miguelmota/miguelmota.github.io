...
if(typeof window.history.pushState!="function")if(window.location.hash=="#!")window.location="/";var pathname=window.location.pathname;$("ul#nav li a").each(function(){if($(this).attr("href")==pathname){$("nav.main a#stream").removeClass("selected");$(this).addClass("selected");switch($(this).attr("id")){case "stream":streamPage();break;case "portfolio":portfolioPage();break;case "contact":contactPage();break;case "blog":blogPage();break;default:break}}else{streamPage();document.title="Miguel Mota | Freelance Web Developer"}});
