...
1);return c[a].apply(c,b)}else return this.each(function(){var b=g(this).data("jcarousel");b?(a&&g.extend(b.options,a),b.reload()):g(this).data("jcarousel",new f(this,a))})}})(jQuery);$(document).ready(function(){if(screen.width<=640){$("h1.title").insertAfter(".nav-logo",function(){$(".sub").remove()});$("#cse-search-form").insertAfter(".blog-description")}$("body").fadeIn(650,function(){$("div.ie-bar").slideDown("slow")});$("div.ie-bar a.ie-bar-close").click(function(){$("div.ie-bar").slideUp("normal")});if(typeof window.history.pushState!="function")if(window.location.hash=="#!")window.location="/";$("a[rel*=internal]").live("click",function(e){e.preventDefault();return false});
...
"</a> <time class='status-date'>"+niceTime(date)+"</time>","</li>")}html.push("</ul>");document.getElementById("stream-wakoopa-software").innerHTML=html.join("");$(".stream-wakoopa div.loader").css("display","none");showMtip(".stream-logo-wakoopa")});$.getJSON("http://api.flickr.com/services/feeds/photos_public.gne?jsoncallback=?",{format:"json",id:"40464790@N08",tags:"outdoors, los angeles, vans warped tour",tagmode:"any"},jsonFlickrFeed);function jsonFlickrFeed(data){var htmlString='<ul class="stream-ul stream-ul-flickr jcarousel-skin-tango">';
$.each(data.items,function(i,item){var thumbnail=item.media.m;var thumbnail_small=item.media.m.replace("_m.jpg","_s.jpg");var photo=item.media.m.replace("_m.jpg","_b.jpg");htmlString+="<li><a class='fancybox' rel='flickr internal' href='"+photo+"' title='"+item.title+"' ><img src='"+thumbnail+"' alt='' /></a></li>";if(i==3)return false});$(".stream-flickr div.loader").css("display","none");$(".stream-flickr").append(htmlString+"</ul>");showMtip(".stream-logo-flickr");$(".stream-ul-flickr").jcarousel()}
c++;refreshStream()}function refreshStream(){setTimeout(function(){if(window.location.pathname.substr(1)=="stream"||window.location.pathname.substr(1)=="index"||window.location.pathname=="")$("a#stream").trigger("click")},3E4)}}
