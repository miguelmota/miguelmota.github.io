...
function showNewContent(){$("nav.main a").removeClass("selected");$("#"+window.location.hash.substr(2)).addClass("selected");$("section.content, footer.main").fadeIn("normal",hideLoader);var title=$("span.sub").text()+$("div.theTitle").text();document.title=title;if(window.location.hash=="#!")document.title=theTitle;var stateObj={foo:window.location.hash.substr(2)};history.pushState(stateObj,"Title",window.location.hash.substr(2))}function hideLoader(){$("div.loader").hide()}
