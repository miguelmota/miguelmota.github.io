...
true){var str=$("form.contact-form").serialize();$.ajax({type:"get",url:"http://miguelmota.webuda.com/contact/contact.php",data:str,success:function(){success()},error:function(){$("a.contact-submit").html("<span>sending...</span>");var message=$("input#message").val();$("form.contact-form").slideUp(300,function(){$(".content").append("<p>Sorry, there was an error. Message was not sent.</p><p>Email <a href='mailto:hello@miguelmota.com?body="+message+"'>hello@miguelmota.com</a>?</p>")})}});return false}else return false});
function success(){$("a.contact-submit").html("<span>sending...</span>");var name=$("input#name").val();$("form.contact-form").slideUp(300,function(){$(".content").append("<p>Thank you <strong>"+name+"</strong>, <br />Your message has been successfully sent!<br />I will get in touch with you soon.</p>").fadeIn(1200)})}}tc=0;
