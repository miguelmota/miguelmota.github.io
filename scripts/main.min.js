...
"/";$("ul.nav li a").each(function(){if($(this).attr("href")==pathname){$("nav.main a#stream").removeClass("selected");$(this).addClass("selected");switch($(this).attr("id")){case "stream":streamPage();break;case "portfolio":portfolioPage();break;case "contact":contactPage();break;case "blog":blogPage();break;default:break}}else{streamPage();$("nav.main a#stream").addClass("selected")}});$("body").append("<div class='theTitle' style='display: none;'> &#8212; Miguel Mota | Freelance Web Developer</div>");
