...
$("a[href^=http]:not([rel*=internal])").live("click",function(){window.open(this.href);return false});$("a.fancybox").fancybox({showCloseButton:false,titlePosition:"inside",titleFormat:formatTitle,padding:0,transitionIn:"none",transitionOut:"none",speedIn:150,overlayColor:"#000",overlayOpacity:0.8});function formatTitle(title,currentArray,currentIndex,currentOpts){return'<div class="fancybox-title"><span><a class="button" href="javascript:void(0);" onclick="$.fancybox.close();">close X</a></span>'+
(title&&title.length?"<strong>"+title+"</strong>":"")+"Image "+(currentIndex+1)+" of "+currentArray.length+"</div>"}$("ul.main-nav li a").each(function(){if($(this).attr("id")==$("section.content").attr("class").split(" ")[1]){$(this).addClass("selected");switch($("section.content").attr("class").split(" ")[1]){case "stream":streamPage();break;case "about":break;case "portfolio":portfolioPage();break;case "contact":contactPage();break;case "blog":blogPage();default:break}}});$("body").append("<div class='theTitle' style='display: none;'> &#8212; Miguel Mota | Freelance Web Developer</div>");
