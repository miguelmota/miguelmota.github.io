...
$(document).ajaxComplete(function(){var path=window.location.pathname.substring(1);switch(path){case "":case "index":case "stream":streamPage();break;case "portfolio":portfolioPage();break;case "contact":contactPage();break;default:break}});
