...
"</a> <time class='status-date'>"+niceTime(date)+"</time>","</li>")}html.push("</ul>");document.getElementById("stream-wakoopa-software").innerHTML=html.join("");$(".stream-wakoopa div.loader").css("display","none");showMtip(".stream-logo-wakoopa")});$.getJSON("http://api.flickr.com/services/feeds/photos_public.gne?jsoncallback=?",{format:"json",id:"40464790@N08",tags:"outdoors, los angeles, vans warped tour",tagmode:"any"},jsonFlickrFeed);function jsonFlickrFeed(data){var htmlString='<a href="javascript:void(0);" class="prev">prev</a><ul class="stream-ul stream-ul-flickr jcarousel-skin-tango">';
$.each(data.items,function(i,item){var thumbnail=item.media.m;var thumbnail_small=item.media.m.replace("_m.jpg","_s.jpg");var photo=item.media.m.replace("_m.jpg","_b.jpg");htmlString+="<li><a class='fancybox' rel='flickr internal' href='"+photo+"' title='"+item.title+"' ><img src='"+thumbnail+"' alt='' /></a></li>";if(i==19)return false});$(".stream-flickr div.loader").css("display","none");$(".stream-flickr").append(htmlString+'</ul><a href="javascript:void(0);" class="next">next</a>');showMtip(".stream-logo-flickr");
