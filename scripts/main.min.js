...
bc++}if(window.location.pathname.substr(1)=="archive"){$("nav.main a#stream").removeClass("selected");$("nav.main a#blog").addClass("selected")}});var c=0;var bc=0;var pathname=window.location.pathname;
...
showNewContent2);function showNewContent2(){$("div.posti").fadeIn("normal",hideLoader);loadDisqus()}}return false});var position=0;var length="portfolio".length;
