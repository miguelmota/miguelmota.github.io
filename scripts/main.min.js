...
$("nav.main a:not('#logo')").live("click",function(){c=0;bc=0;var toLoad=$(this).attr("href")+" section.content";$("section.content").fadeOut("fast",loadContent);$("div.loading").fadeIn("normal");function loadContent(){$("section.content").load(toLoad,showNewContent)}if(typeof window.history.pushState=="function"){var stateObj={foo:$(this).attr("href")};history.pushState(stateObj,"Title",$(this).attr("href"))}else window.location=$(this).attr("href");return false});
...
function showNewContent(){if(typeof window.history.pushState!="function")$("#"+window.location.hash.substr(2)).addClass("selected");$("section.content, footer.main").fadeIn("normal",hideLoader)}function hideLoader(){$("div.loading").hide()}
