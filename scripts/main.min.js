...
enableKeyboardNav:true,onStart:function(){},onCancel:function(){},onComplete:function(){},onCleanup:function(){},onClosed:function(){},onError:function(){}};a(document).ready(function(){a.fancybox.init()})})(jQuery);$(document).ready(function(){if(window.innerWidth<=640)window.location="http://www.miguelmota.com/mobile";$("body").fadeIn(650,function(){$("div#ie").slideDown("slow")});$("div#ie a#close").click(function(){$("div#ie").slideUp("normal")});if(typeof window.history.pushState!="function")if(window.location.hash=="#!")window.location="/";switch(pathname.substr(1)){case "stream":streamPage();$("a#stream").addClass("selected");break;case "about":$("a#about").addClass("selected");break;case "portfolio":portfolioPage();
$("a#portfolio").addClass("selected");break;case "contact":contactPage();$("a#contact").addClass("selected");break;case "blog":blogPage();$("a#blog").addClass("selected");break;default:break}switch(pathname.substr(1,4)){case "post":blogPage();$("a#blog").addClass("selected");break;default:break}switch(pathname.substr(1,7)){case "archive":$("a#blog").addClass("selected");break;default:break}$("ul#nav li a").each(function(){if($(this).attr("href")==pathname);else{streamPage();document.title="Miguel Mota | Freelance Web Developer"}});
$("a#"+$("span.sub").text()).addClass("selected");$("body").append("<div class='theTitle' style='display: none;'> &#8212; Miguel Mota | Freelance Web Developer</div>");if(typeof window.history.pushState!="function")if(window.location.hash)window.location="/"+window.location.hash.substr(2);$("a[href*=#]").click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var $target=$(this.hash);$target=$target.length&&$target||$("[name="+this.hash.slice(1)+
