...
$("nav.main a#blog").addClass("selected")}});$("nav.main a").live("click",function(){c=0;bc=0;var toLoad=$(this).attr("href")+" section.content";$("section.content").fadeOut("fast",loadContent);$("div.loader").fadeIn("normal");function loadContent(){$("section.content").load(toLoad,showNewContent)}if(typeof window.history.pushState=="function"){var stateObj={foo:$(this).attr("href")};history.pushState(stateObj,"Title",$(this).attr("href"))}else alert("update your browser!!");return false});
