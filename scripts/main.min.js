...
loadContent);$("div.loader").fadeIn("normal");function loadContent(){$("section.content").load(toLoad,showNewContent)}return false}function redirectPath(){var pathname=window.location.pathname;alert(pathname);switch(pathname){case "":case "index":case "stream":case "portfolio":case "contact":case "blog":window.location="./#!"+path;default:break}}$(window).scroll(function(){var scrollTop=$(document).scrollTop();scrollTop=parseInt(scrollTop);var offset=topYloc+scrollTop+"px";$("a.top").animate({top:offset},
