...
showNewContent2);function showNewContent2(){$("div.posti").fadeIn("normal",hideLoader);loadDisqus()}}return false});function textticker(){$("a#stream").text("stream".substr(0));$("a#about").text("about".substr(0));$("a#portfolio").text("portfolio".substr(0));$("a#contact").text("contact".substr(0));$("a#blog").text("blog".substr(0));if(position++==8)setTimeout("textticker()",1E3);else setTimeout("textticker()",60)}
