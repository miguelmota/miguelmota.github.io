...
$("nav.main a").live("click",function(){c=0;var toLoad=$(this).attr("href")+" section.content";$("section.content").fadeOut("fast",loadContent);$("div.loader").fadeIn("normal");function loadContent(){$("section.content").load(toLoad,showNewContent)}return false;var stateObj={foo:$(this).attr("href")};history.pushState(stateObj,"Title",$(this).attr("href"))});
...
function showNewContent(){$("nav.main a").removeClass("selected");$("section.content, footer.main").fadeIn("normal",hideLoader);var title=$("span.sub").text()+$("div.theTitle").text();document.title=title}function hideLoader(){$("div.loader").hide()}
