...
item.media.m.replace("_m.jpg","_s.jpg");htmlString+="<li><a class='fancybox' rel='miguelmota' href='"+item.link+"' title='"+item.title+"' ><img src='"+sourceSquare+"' alt='' /></a></li>";if(i==3)return false});$(".flickr-stream").html(htmlString+"</ul>")}c++;refreshStream()}function refreshStream(){setTimeout(function(){if(window.location.pathname.substr(1)=="stream"||window.location.pathname.substr(1)=="index"||window.location.pathname=="")$("a#stream").trigger("click")},3E4)}}
