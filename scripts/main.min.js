...
$("nav.main a:not('a#blog')").live("click",function(){c=0;var toLoad=$(this).attr("href")+" section.content";window.location.hash="!"+$(this).attr("href").substr(23,$(this).attr("href").length);$("section.content").fadeOut("fast",loadContent);$("div.loader").fadeIn("normal");function loadContent(){$("section.content").load(toLoad,showNewContent)}return false});var position=0;var length="portfolio".length;
