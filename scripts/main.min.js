...
enableKeyboardNav:true,onStart:function(){},onCancel:function(){},onComplete:function(){},onCleanup:function(){},onClosed:function(){},onError:function(){}};a(document).ready(function(){a.fancybox.init()})})(jQuery);$(document).ready(function(){if(window.innerWidth<=640){$("div#wrap").prepend("<a id='mobile_bar' href='/mobile'>view mobile site</a><a id='mobile_close' href='javascript:void(0);'>x</a>");$("a#mobile_close").live("click",function(){$(this).hide();$("a#mobile_bar").slideUp("normal")})}$("body").fadeIn(650,function(){$("div#ie").slideDown("slow")});$("div#ie a#close").click(function(){$("div#ie").slideUp("normal")});if(typeof window.history.pushState!="function")if(window.location.hash=="#!")window.location=
"/";streamPage();$("nav.main a#stream").addClass("selected");var pathname=window.location.pathname;$("ul.nav li a").each(function(){if($(this).attr("href")==pathname){$("nav.main a#stream").removeClass("selected");$(this).addClass("selected");switch($(this).attr("id")){case "stream":streamPage();break;case "portfolio":portfolioPage();break;case "contact":contactPage();break;case "blog":blogPage();break;default:break}}});$("body").append("<div class='theTitle' style='display: none;'> &#8212; Miguel Mota | Freelance Web Developer</div>");
if(typeof window.history.pushState!="function")if(window.location.hash)loadPage();else redirectPath();function loadPage(){var toLoad="/"+window.location.hash.substr(2)+" section.content";window.location.hash=window.location.hash.substr(1);$("section.content").fadeOut("fast",loadContent);$("div.loader").fadeIn("normal");alert(toLoad);function loadContent(){$("section.content").load(toLoad,showNewContent)}return false}if(typeof window.history.pushState!="function"){function redirectPath(){var pathname=
window.location.pathname.substr(1);switch(pathname){case "":case "index":case "stream":break;case "portfolio":break;case "contact":break;case "blog":break;window.location="./#!"+path;default:break}}}$("a[href*=#]").click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var $target=$(this.hash);$target=$target.length&&$target||$("[name="+this.hash.slice(1)+"]");if($target.length){var targetOffset=$target.offset().top;$("html,body").animate({scrollTop:targetOffset},
1E3);return false}}});$(window).scroll(function(){var scrollTop=$(document).scrollTop();scrollTop=parseInt(scrollTop);var offset=topYloc+scrollTop+"px";$("a.top").animate({top:offset},{duration:500,queue:false})});topYloc=parseInt($("a.top").css("top").substring(0,$("a.top").css("top").indexOf("px")))});$(window).scroll(function(){if(window.pageYOffset>=200)$("a.top").fadeIn(600);if(window.pageYOffset<200)$("a.top").fadeOut(185)});
...
bc++}if(window.location.pathname.substr(1)=="archive"){$("nav.main a#stream").removeClass("selected");$("nav.main a#blog").addClass("selected")}});var c=0;var bc=0;
...
["<ul class='wakoopa_software'>"];for(var i=0;i<data.length;i++){var entry=data[i].software;var date=(new Date(entry.last_active_at)).toUTCString();html.push("<li><a class='link' href='",entry.complete_url,"'>",entry.name,"</a> <span class='date'>"+niceTime(date)+"</span>","</li>")}html.push("</ul>");document.getElementById("wakoopa_software").innerHTML=html.join("");$("div.wakoopa img.loader").css("display","none")});c++;refreshStream()}function refreshStream(){setTimeout(function(){if(window.location.pathname.substr(1)==
...
300)}}function blogPage(){loadSearch();loadDisqus()}google.load("search","1",{language:"en"});function loadSearch(){var customSearchControl=new google.search.CustomSearchControl("013110027163283765539:a-en5rcxdcu");customSearchControl.setResultSetSize(google.search.Search.FILTERED_CSE_RESULTSET);customSearchControl.draw("cse")};