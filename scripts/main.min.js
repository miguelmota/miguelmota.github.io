...
mouseleave:function(){jQuery("span.overlay",this).hide().fadeIn(300);$(this).css({"-webkit-box-shadow":"2px 2px 5px #111","-moz-box-shadow":"2px 2px 5px #111","box-shadow":"2px 2px 5px #111"})}});$(".project .image-container").live({mouseenter:function(){$(".project .image-container img").wrap("<a href='/portfolio/"+$(this).attr("data-link")+"'></a>");jQuery(".overlay-popup",this).animate({bottom:"0"},200)},mouseleave:function(){jQuery(".overlay-popup",this).animate({bottom:"-100px"},150)}});$("a.fancybox").hover(function(){jQuery("span.zoom-icon",
