...
function refreshStream(){setTimeout(function(){if(window.location.pathname.substr(1)=="stream"||window.location.pathname.substr(1)=="index"||window.location.pathname=="")$("a#stream").trigger("click")},3E4)}function portfolioPage(){$("a.fancybox").fancybox({padding:0,transitionIn:"fade",transitionOut:"fade",speedIn:600,speedOut:200,overlayColor:"#000"})}
