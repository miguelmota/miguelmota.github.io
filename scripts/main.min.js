...
$("nav.main a").live("click",function(){c=0;var toLoad=$(this).attr("href")+" section.content";$("section.content").fadeOut("fast",loadContent);$("div.loader").fadeIn("normal");function loadContent(){$("section.content").load(toLoad,showNewContent)}return false;var stateObj={foo:$(this).attr("href").substr(1)};history.pushState(stateObj,"Title",$(this).attr("href").substr(1))});
