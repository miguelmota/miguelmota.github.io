...
"/";$("ul.nav li a").each(function(){if($(this).attr("href")==pathname)switch($(this).attr("id")){case "stream":streamPage();break;case "portfolio":portfolioPage();break;case "contact":contactPage();break;case "blog":blogPage();break;default:break}else streamPage()});$("a#"+$("span.sub").text()).addClass("selected");$("body").append("<div class='theTitle' style='display: none;'> &#8212; Miguel Mota | Freelance Web Developer</div>");if(typeof window.history.pushState!="function")if(window.location.hash)window.location=
...
$(document).ajaxComplete(function(){if(typeof window.history.pushState!="function")var path2=window.location.hash.substr(2);else var path2=window.location.pathname.substring(1);var title=$("h1.title span.sub").text()+$("div.theTitle").text();document.title=title;$("nav.main a").removeClass("selected");if(path2.substr(3)!="")$("nav.main a#"+path2).addClass("selected");else $("nav.main a#stream").addClass("selected");switch(path2){case "":case "index":case "stream":streamPage();break;case "portfolio":portfolioPage();
break;case "contact":contactPage();break;case "blog":blogPage();break;default:break}if(window.location.pathname.substr(1,4)=="post")while(bc==0){blogPage();$("nav.main a#stream").removeClass("selected");$("nav.main a#blog").addClass("selected");bc++}if(window.location.pathname.substr(1)=="archive"){$("nav.main a#stream").removeClass("selected");$("nav.main a#blog").addClass("selected")}});var c=0;var bc=0;var pathname=window.location.pathname;
