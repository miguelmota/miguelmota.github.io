...
"-moz-box-shadow":"2px 2px 5px #111","box-shadow":"2px 2px 5px #111"})}});$(".project").live({mouseenter:function(){jQuery(".overlay-popup",this).animate({bottom:"0"},{queue:false,duration:200})},mouseleave:function(){jQuery(".overlay-popup",this).animate({bottom:"-95px"},{queue:false,duration:150})}});$("a.fancybox").hover(function(){jQuery("span.zoom-icon",this).css("display","block")},function(){jQuery("span.zoom-icon",this).hide()});$("a.fancybox").fancybox({showCloseButton:false,titlePosition:"inside",
