...
"hidden";aa.style.display="none";ay(true)};if(ao)N(ae,"opacity",0,Q.options.fadeDuration,K);else K()};T.onPlay=function(){r("play",false);r("pause",true)};T.onPause=function(){r("pause",false);r("play",true)};T.onWindowResize=function(){if(!m)return;aB();var K=Q.player,S=ak(K.height,K.width);ar(S.width,S.left);ac(S.innerHeight,S.top);if(K.onWindowResize)K.onWindowResize()};Q.skin=T;au.Shadowbox=Q})(window);$(document).ready(function(){if(window.innerWidth<=640){$("div#wrap").prepend("<a id='mobile_bar' href='/mobile'>view mobile site &#187;</a><a id='mobile_close' href='javascript:void(0);'>x</a>");$("a#mobile_bar").hide();setTimeout(function(){$("a#mobile_bar").slideDown("slow")},2500);$("a#mobile_close").live("click",function(){$(this).hide();$("a#mobile_bar").slideUp("normal")})}$("body").fadeIn(650,function(){$("div#ie").slideDown("slow")});$("div#ie a#close").click(function(){$("div#ie").slideUp("normal")});
if(typeof window.history.pushState!="function")if(window.location.hash=="#!")window.location="/";$("ul.nav li a").each(function(){if($(this).attr("href")==pathname)switch($(this).attr("id")){case "stream":streamPage();break;case "portfolio":portfolioPage();break;case "contact":contactPage();break;case "blog":blogPage();break;default:break}else{streamPage();document.title="Miguel Mota | Freelance Web Developer"}});$("a#"+$("span.sub").text()).addClass("selected");$("body").append("<div class='theTitle' style='display: none;'> &#8212; Miguel Mota | Freelance Web Developer</div>");
...
$(document).scrollTop();scrollTop=parseInt(scrollTop);var offset=topYloc+scrollTop+"px";$("a.top").animate({top:offset},{duration:500,queue:false})});topYloc=parseInt($("a.top").css("top").substring(0,$("a.top").css("top").indexOf("px")))});$(window).scroll(function(){if(window.pageYOffset>=200)$("a.top").fadeIn(600);if(window.pageYOffset<200)$("a.top").fadeOut(185)});
$(document).ajaxComplete(function(){if(typeof window.history.pushState!="function")var path2=window.location.hash.substr(2);else var path2=window.location.pathname.substr(1);var title=$("h1.title span.sub").text()+$("div.theTitle").text();document.title=title;$("nav.main a").removeClass("selected");if(path2!="")$("nav.main a#"+path2).addClass("selected");else{$("nav.main a#stream").addClass("selected");document.title="Miguel Mota | Freelance Web Developer"}switch(path2){case "":case "index":case "stream":streamPage();
break;case "portfolio":portfolioPage();break;case "contact":contactPage();break;case "blog":blogPage();break;default:break}if(window.location.pathname.substr(1,4)=="post")while(bc==0){blogPage();$("nav.main a#stream").removeClass("selected");$("nav.main a#blog").addClass("selected");bc++}if(window.location.pathname.substr(1)=="archive"){$("nav.main a#stream").removeClass("selected");$("nav.main a#blog").addClass("selected")}});var c=0;var bc=0;var pathname=window.location.pathname;
...
$("nav.main a:not('#logo')").live("click",function(){c=0;bc=0;var toLoad=$(this).attr("href")+" section.content";$("section.content").fadeOut("fast",loadContent);$("div.loading").fadeIn("normal");function loadContent(){$("section.content").load(toLoad,showNewContent)}if(typeof window.history.pushState=="function"){var stateObj={foo:$(this).attr("href")};history.pushState(stateObj,"Title",$(this).attr("href"))}else window.location.hash="!"+$(this).attr("href").substr(1,$(this).attr("href").length);
return false});
$("div.posti h3 a").live("click",function(){var toLoad2=$(this).attr("href")+" div.posti";$("div.posti").fadeOut("fast",loadContent2);$("div.loading").fadeIn("normal");if(typeof window.history.pushState=="function"){var stateObj2={foo2:$(this).attr("href")};history.pushState(stateObj2,"Title2",$(this).attr("href"))}else window.location.hash="!"+$(this).attr("href").substr(1,$(this).attr("href").length);var title2=$(this).text()+$("div.theTitle").text();document.title=title2;function loadContent2(){$("div.posti").load(toLoad2,showNewContent2);
function showNewContent2(){$("div.posti").fadeIn("normal",hideLoader);loadDisqus()}}return false});var position=0;var length="portfolio".length;
function textticker(){$("a#stream").text("stream".substring(0,position));$("a#about").text("about".substring(0,position));$("a#portfolio").text("portfolio".substring(0,position));$("a#contact").text("contact".substring(0,position));$("a#blog").text("blog".substring(0,position));if(position++==8)setTimeout("textticker()",1E3);else setTimeout("textticker()",60)}function showNewContent(){if(typeof window.history.pushState!="function");$("section.content, footer.main").fadeIn("normal",hideLoader)}
function hideLoader(){$("div.loading").hide()}
function streamPage(){$(".mtip").mtip();while(c==0){$("div.stream a.social:not('.latitude')").text("");$("div.facebook img.loader").css("display","block");$.getJSON("https://graph.facebook.com/miguel.mota2/feed?limit=3&callback=?",function(json){$.each(json.data,function(i,fb){var post=fb.message;var post_id=fb.id.substr(16);var type=fb.type;var link=fb.link;var name=fb.name;var caption=fb.caption;var description=fb.description;var date=(new Date(fb.created_time)).toUTCString();switch(type){case "status":$("ul.facebook_status").append("<li class='status'>&#187; <span class='post'>"+
post+"</span> <span class='date'><a href='http://www.facebook.com/miguel.mota2/posts/"+post_id+"'>"+niceTime(date)+"</a></span></li>");break;case "link":if(post)$("ul.facebook_status").append("<li class='status'>&#187; Link: <span class='post'>"+post+" <a href='"+link+"'>"+name+"</a></span> <span class='date'><a href='http://www.facebook.com/miguel.mota2/posts/"+post_id+"'>"+niceTime(date)+"</a></span></li>");else $("ul.facebook_status").append("<li class='status'>&#187; Link: <a href='"+link+"'>"+
name+"</a></span> <span class='date'><a href='http://www.facebook.com/miguel.mota2/posts/"+post_id+"'>"+niceTime(date)+"</a></span></li>");break;case "video":if(post)$("ul.facebook_status").append("<li class='status'>&#187; Video: <span class='post'>"+post+" <a href='"+link+"'>"+name+"</a></span> <span class='date'><a href='http://www.facebook.com/miguel.mota2/posts/"+post_id+"'>"+niceTime(date)+"</a></span></li>");else $("ul.facebook_status").append("<li class='status'>&#187; Video: <span class='post'><a href='"+
link+"'>"+name+"</a></span> <span class='date'><a href='http://www.facebook.com/miguel.mota2/posts/"+post_id+"'>"+niceTime(date)+"</a></span></li>");break;default:break}});$("div.facebook img.loader").css("display","none")});$("div.twitter img.loader").css("display","block");$.getJSON("http://twitter.com/status/user_timeline/miguel_mota.json?&count=5&callback=?",function(data){$.each(data,function(i,status){var post=status.text;var id=status.id_str;var date=(new Date(status.created_at)).toUTCString();
var newText="<span>"+post.split(" ").join("</span> <span>")+"</span>";$("ul.twitter_status").append("<li id='"+id+"' class='status'>&#187; <span class='post'>"+newText+"</span> <span class='date'><a href='http://twitter.com/miguel_mota/status/"+id+"'>"+niceTime(date)+"</a></span></li>");$("li.status[id='"+id+"'] span").find(":contains('http')").wrapInner("<a href='"+$("li.status[id='"+id+"'] span").find(":contains('http')").text()+"'> </a>");$("li.status[id='"+id+"'] span").find(":contains('@')").wrapInner("<a href='http://twitter.com/"+
$("li.status[id='"+id+"'] span").find(":contains('@')").text().substr(1)+"'> </a>")});$("div.twitter img.loader").css("display","none")});$("div.tumblr img.loader").css("display","block");$.getJSON("http://miguelmota.tumblr.com/api/read/json?num=3&callback=?",function(data){$.each(data.posts,function(i,posts){var date=(new Date(this["date-gmt"])).toUTCString();var url=this.url;var caption=this["photo-caption"];var slug=this.slug.replace(/-/g," ");$("ul.tumblr_posts").append("<li>&#187; <a href='"+
url+"'>"+slug.substring(0,1).toUpperCase()+slug.substr(1,200)+"</a> <span class='date'>"+niceTime(date)+"</span></li>")});$("div.tumblr img.loader").css("display","none")});$("div.delicious img.loader").css("display","block");$.getJSON("http://feeds.delicious.com/v2/json/miguelmota/?count=3&callback=?",function(data){$.each(data,function(i,item){var title=item.d;var url=item.u;var date=(new Date(item.dt)).toUTCString();$("ul.delicious_bookmarks").append("<li>&#187; <a href='"+url+"'>"+title+"</a> <span class='date'>"+
niceTime(date)+"</span></li>")});$("div.delicious img.loader").css("display","none")});$("div.lastfm img.loader").css("display","block");$.getJSON("http://ws.audioscrobbler.com/2.0/?method=user.getRecentTracks&user=miguel_mota&api_key=b25b959554ed76058ac220b7b2e0a026&format=json&limit=5&callback=?",function(data){$.each(data.recenttracks.track,function(i,item){var url=item.url;var name=item.name;var artist=item.artist["#text"];var date=item.date["#text"];$("ul.lastfm_tracks").append("<li><a class='link' href='"+
url+"'>"+artist+" - "+name+"</a> <span class='date'>"+date+"</span></li>")});$("div.lastfm img.loader").css("display","none")});$("div.wakoopa img.loader").css("display","block");$.getJSON("http://api.wakoopa.com/miguelmota/recently_used.json?limit=3&callback=?",function wakoopaApi(data){var html=["<ul class='wakoopa_software'>"];for(var i=0;i<data.length;i++){var entry=data[i].software;var date=(new Date(entry.last_active_at)).toUTCString();html.push("<li><a class='link' href='",entry.complete_url,
"'>",entry.name,"</a> <span class='date'>"+niceTime(date)+"</span>","</li>")}html.push("</ul>");document.getElementById("wakoopa_software").innerHTML=html.join("");$("div.wakoopa img.loader").css("display","none")});c++;refreshStream()}function refreshStream(){setTimeout(function(){if(window.location.pathname.substr(1)=="stream"||window.location.pathname.substr(1)=="index"||window.location.pathname=="")$("a#stream").trigger("click")},3E4)}}
...
$(this).css({"-webkit-box-shadow":"2px 2px 5px #111","-moz-box-shadow":"2px 2px 5px #111","box-shadow":"2px 2px 5px #111"})});Shadowbox.init()}
...
300)}}function blogPage(){loadSearch();loadDisqus()}
...
(document.getElementsByTagName("HEAD")[0]||document.getElementsByTagName("body")[0]).appendChild(s)})()}google.load("search","1",{language:"en"});function loadSearch(){var customSearchControl=new google.search.CustomSearchControl("013110027163283765539:a-en5rcxdcu");customSearchControl.setResultSetSize(google.search.Search.FILTERED_CSE_RESULTSET);customSearchControl.draw("cse")};