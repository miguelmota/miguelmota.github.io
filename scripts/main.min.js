...
function showNewContent(){$("nav.main a").removeClass("selected");if(typeof window.history.pushState!="function")$("#"+window.location.hash.substr(2)).addClass("selected");$("#"+window.location.pathname.substr(1)).addClass("selected");$("section.content, footer.main").fadeIn("normal",hideLoader);var title=$("h1.title span.sub").text()+$("div.theTitle").text();document.title=title;if(typeof window.history.pushState!="function")if(window.location.hash=="#!"){$("#"+window.location.hash.substr(2));document.title=
theTitle}}function hideLoader(){$("div.loading").hide()}
