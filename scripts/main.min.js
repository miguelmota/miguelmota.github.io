...
$(".project:not('.project-identity')").slideUp("fast");$(".project-identity").slideDown("fast")});$(".work-sort-code").live("click",function(){$(".work-sort-wrap a").removeClass("selected");$(this).addClass("selected");$(".project:not('.project-code')").slideUp("fast");$(".project-code").slideDown("fast")});$(".project .image-container").live({mouseenter:function(){$(this).css({"-webkit-box-shadow":"0 0 10px #fff","-moz-box-shadow":"0 0 10px #fff","box-shadow":"0 0 10px #fff"})},mouseleave:function(){$(this).css({"-webkit-box-shadow":"2px 2px 5px #111",
"-moz-box-shadow":"2px 2px 5px #111","box-shadow":"2px 2px 5px #111"})}});$(".project").live({mouseenter:function(){jQuery(".overlay-popup",this).animate({bottom:"0"},{queue:false,duration:200,easing:"expoEaseIn"})},mouseleave:function(){jQuery(".overlay-popup",this).animate({bottom:"-95px"},{queue:false,duration:200,easing:"expoEaseOut"})}});$("a.fancybox").hover(function(){jQuery("span.zoom-icon",this).css("display","block")},function(){jQuery("span.zoom-icon",this).hide()});$("a.fancybox").fancybox({showCloseButton:false,
titlePosition:"inside",titleFormat:formatTitle,padding:0,transitionIn:"none",transitionOut:"none",speedIn:150,overlayColor:"#000",overlayOpacity:0.8});function formatTitle(title,currentArray,currentIndex,currentOpts){return'<div class="fancybox-title"><span><a href="javascript:void(0);" onclick="$.fancybox.close();">close X</a></span>'+(title&&title.length?"<strong>"+title+"</strong>":"")+"Image "+(currentIndex+1)+" of "+currentArray.length+"</div>"}}
