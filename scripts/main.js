...
function streamPage(){
	...
	$.getJSON('http://www.google.com/latitude/apps/badge/api?user=7812482200199007583&type=json&callback=?', 
			...
			//},
			function(data){
				$.each(data.features.properties, function(i, item){
					...
					var location = item.reverseGeocode;
		    	  	...
		    	  	htmlString += "<li><a href='"+url+"' rel='external'><span class='icon icon-link-16'></span> "+location+"</a> <time class='status-date'>"++"</time></li>";
